...
public protocol FacebookAuthServiceInterface {
    
    /// The view controller to present from.
    var targetView: UIViewController? { get set }
    
    /// Array of permissions.
    var permissions: [FacebookPermissionType] { get set }
...
public class FacebookAuthService: FacebookAuthServiceInterface {
    
    // MARK: Properties
    public var permissions: [FacebookPermissionType] = []
